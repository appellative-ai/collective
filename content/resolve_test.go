...
func ExampleResolution_PutValue() {
	...
	//Output:
	//test: PutValue_Name() -> [status:Bad Request [err:name is empty on call to PutValue()] [agent:resiliency:agent/domain/content/content]]
	//test: PutValue_Name() -> [status:No Content [err:content is nil on call to PutValue() for name : type/test] [agent:resiliency:agent/domain/content/content]]
	//test: PutValue_Name() -> [status:No Content [err:content is empty on call to PutValue() for name : type/test] [agent:resiliency:agent/domain/content/content]]
